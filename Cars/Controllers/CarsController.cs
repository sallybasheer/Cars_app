...
namespace Cars.Controllers
{
    ...
    public class CarsController : ControllerBase
    {
        ...
        {
            var car = _dbcontext.Car.Where(x=>x.car_id==id).ToList();
        ...
        {
            var color = _dbcontext.Color.Where(x => x.color_id == id).ToList();
       ...
       public IActionResult PostColor( Color request)
        ...
        [HttpGet("GetEngine/{id}")]
        public IActionResult GetEngineByid(int id)
        {
            var engine = _dbcontext.Engine.Where(x => x.engine_id == id).ToList();
        ...
        {
            var fuel = _dbcontext.Fuel.Where(x => x.fuel_id == id).ToList();
        ...
        {
            var gear = _dbcontext.Gear.Where(x => x.gear_id== id).ToList();
        ...
        [HttpGet("GetSqlite/{name}")]
        public IActionResult GetSqliteByid(string name)
        {
            var sqlite = _dbcontext.sqlite_sequence.Where(x => x.name== name).ToList();
        ...
        {
            var truck = _dbcontext.Truck.Where(x => x.truck_id == id).ToList();
        ...
        {
            var motorcycle = _dbcontext.Motorcycle.Where(x => x.motorcycle_id == id).ToList();
